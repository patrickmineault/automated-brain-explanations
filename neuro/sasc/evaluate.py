...
def compute_score_contains_keywords(args, explanation_strs):
    ...
    task_str = neuro.sasc.data.data.get_task_str(
        args.module_name, args.module_num)
    check_func = neuro.sasc.data.data.get_groundtruth_keywords_check_func(
        task_str)
...
def compute_score_bert(args, explanation_strs):
    ...
    task_str = neuro.sasc.data.data.get_task_str(
        args.module_name, args.module_num)
    keyword_groundtruth = neuro.sasc.data.data.get_groundtruth_keyword(
        task_str)
